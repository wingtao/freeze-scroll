(function () {
  ...
  */
  ...
  function (_React$Component) {
    _inherits(FreezeScroll, _React$Component);
    ...
    function FreezeScroll() {
      ...
      _classCallCheck(this, FreezeScroll);

      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(FreezeScroll)).call.apply(_getPrototypeOf2, [this].concat(args)));
      _this.state = {
        slideDis: 0,
        duration: 0
      };
      _this.moveHandler = _this.moveHandler.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.endHandler = _this.endHandler.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.getCont = _this.getCont.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.startHandler = _this.startHandler.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      return _this;
    }

    _createClass(FreezeScroll, [{
      ...
      value: function moveHandler(e) {
        ...
        var dx = e.touches[0].clientX - this.startX;
      ...
      value: function render() {
        return react.createElement("div", {
          ...
          style: {
            transform: "translate(0px,".concat(this.state.slideDis, "px)"),
            transitionDuration: "".concat(this.state.duration, "ms")
          }
        }, this.props.children));
      }
    }]);
